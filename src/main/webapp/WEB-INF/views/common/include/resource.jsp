...
<%-- Bootstrap Select --%>
<link href="${path}/resource/bootstrap-select/1.12.1/css/bootstrap-select.css" rel="stylesheet" />
<script type="text/javascript" src="${path}/resource/bootstrap-select/1.12.1/js/bootstrap-select.js"></script>

<%-- Bootstrap Treeview --%>
<link href="${path}/resource/bootstrap-treeview/2.1.0/css/bootstrap-treeview.css" rel="stylesheet" />
<script type="text/javascript" src="${path}/resource/bootstrap-treeview/2.1.0/js/bootstrap-treeview.js?11"></script>
