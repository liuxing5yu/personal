...
<%-- jquery-confirm --%>
<link rel="stylesheet" href="${path}/resource/jquery-confirm/3.3.0/jquery-confirm.min.css">
<script src="${path}/resource/jquery-confirm/3.3.0/jquery-confirm.min.js"></script>